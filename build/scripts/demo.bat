...
set CLASSPATH=%APP_HOME%\lib\demo.jar;%APP_HOME%\lib\agrona-1.17.1.jar


@rem Execute demo
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DEMO_OPTS%  -classpath "%CLASSPATH%" com.kestrel.engine.KestrelEngine %*
